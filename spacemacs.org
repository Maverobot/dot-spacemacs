...
#+BEGIN_SRC emacs-lisp :tangle user-config.el
  (use-package org-ai
    :load-path "~/.spacemacs.d/private/org-ai/org-ai.el"
    :ensure
    :commands
      (org-ai-mode)
    :custom
      (org-ai-openai-api-token (auth-source-pick-first-password :host "api.openai.com"))
    :init
  ...
  (require 'whisper
           (expand-file-name "~/.spacemacs.d/private/whisper.el/whisper.el"))
